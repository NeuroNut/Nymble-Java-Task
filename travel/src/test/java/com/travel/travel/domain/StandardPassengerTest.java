...
public class StandardPassengerTest {
    ...
    public void testSignUpForActivity_SuccessfulSignUp() {
        // Arrange
        Passenger passenger = PassengerFactory.createPassenger(STANDARD);
        ...
        assertEquals(0.0, passenger.getPassengerBalance());
    }
    ...
    public void testCanSignUpForActivity_ReturnsTrueWhenSufficientBalance() {
        // Arrange
        Passenger passenger = PassengerFactory.createPassenger(STANDARD);
        passenger.setPassengerBalance(490D);
        Activity activity = mock(Activity.class);
        when(activity.getCost()).thenReturn(50.0);
    ...
    public void testPrintPassengerDetails_PrintsCorrectDetails() {
        ...
        assertTrue(consoleOutput.contains("Cost paid by the customer = 50.0"));
        ...
        assertTrue(consoleOutput.contains("Cost paid by the customer = 60.0"));
    }
}
